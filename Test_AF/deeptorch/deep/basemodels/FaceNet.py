...
def loadModel(eval=True, name='vggface2'):
...
def load_weights(mdl, name):
    ...
    # print("Saving weights to: ", cached_file)
...
def predict(img, tensor, model, resize):
    ...
    if tensor:
        ...
        return torch.argmax(img_tensor)