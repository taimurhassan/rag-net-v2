...
from deep.detectors import FaceDetector
...
def preprocess_face(img, target_size=(112, 112), grayscale = False, enforce_detection = True, detector_backend = 'opencv', return_region = False, align = True):

	#img might be path, base64 or numpy array. Convert it to numpy whatever it is.
	# img = load_image(img) **removed from source code**
	img = cv2.imread(img)
	base_img = img.copy()
...
# We removed here, because we cannot get input size in PyTorch
